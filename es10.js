//new version array methods
.flat();//method
const array = [1,2,3,4,5]
array.flat();
//unnest array array.flat();
// 2nd of es10 feature is  flatmap();
flatmap();
array.flatmap();
//next feature trimstart trimEnd
trimstart(), trimEnd()
// used to close a gap
// forEntries metod
forEntries()
const userprofile = [[[]]]
// thr try n catch method
try {
    true + 'hi'
} catch{
    console.log('u messed uup');
}
//or
try {
    Bob + 'hi'
